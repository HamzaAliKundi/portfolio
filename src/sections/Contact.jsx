...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-16 sm:py-24 md:py-32 pb-12 sm:pb-16 md:pb-24 lg:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-dark-bg">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <span className="text-primary/50 text-lg sm:text-xl md:text-2xl font-mono">05.</span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              <motion.a
                ...
                className="flex items-center gap-3 sm:gap-4 glass-effect p-3 sm:p-4 rounded-lg hover:border-primary/50 transition-all group"
                whileHover={{ x: 5 }}
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary/20 flex items-center justify-center group-hover:bg-primary/30 transition-colors flex-shrink-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-white text-sm sm:text-base truncate">{personal.email}</p>
                </div>
              </motion.a>
              ...
              {personal.phone && (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-white text-sm sm:text-base">{personal.phone}</p>
                  </div>
                </motion.a>
              )}
              ...
              {personal.whatsapp && (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-white text-sm sm:text-base">{personal.whatsapp}</p>
                  </div>
                </motion.a>
              )}
              ...
              <div className="flex gap-3 sm:gap-4 pt-3 sm:pt-4">
                {social.github && (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/5 backdrop-blur-sm flex items-center justify-center text-white hover:bg-primary/20 transition-all"
          ...
          >
            <div>
              <label htmlFor="name" className="block text-xs sm:text-sm font-medium mb-1.5 sm:mb-2 text-white/70">
                Name
              </label>
              <input
                type="text"
                ...
                required
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-primary transition-colors text-white placeholder-white/30"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-primary transition-colors text-white placeholder-white/30 resize-none"
